...
INSERT INTO tb_lesson (title, position, section_id) VALUES ('Crud 1', 1, 1);
INSERT INTO tb_content (id, text_Content, video_Uri) VALUES (1, 'abc', 'https://www.youtube.com/watch?v=0_e9Egeyk2E');

INSERT INTO tb_lesson (title, position, section_id) VALUES ('Crud 2', 2, 1);
INSERT INTO tb_content (id, text_Content, video_Uri) VALUES (2, 'def', 'https://www.youtube.com/watch?v=0_e9Egeyk2E');

INSERT INTO tb_lesson (title, position, section_id) VALUES ('Crud 3', 3, 1);
INSERT INTO tb_content (id, text_Content, video_Uri) VALUES (3, 'abc', 'https://www.youtube.com/watch?v=0_e9Egeyk2E');

INSERT INTO tb_lesson (title, position, section_id) VALUES ('Tarefa crud', 4, 1);
INSERT INTO tb_task (id, description, question_Count, approval_Count, weight, due_Date) VALUES (4, 'Tarefa para entregar', 5, 4, 1.0, TIMESTAMP WITH TIME ZONE '2022-11-25T13:00:00Z');
